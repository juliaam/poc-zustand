import { useGlobalStoreB } from '../stores/store-global-b'
import { StorePanel, ValueDisplay } from './StorePanel'

export function GlobalB() {
  const store = useGlobalStoreB()

  return (
    <StorePanel
      title="Global B: meta.postprocess"
      description="Store global migrado para lenses com meta.postprocess. Requer valores iniciais manuais para computed."
    >
