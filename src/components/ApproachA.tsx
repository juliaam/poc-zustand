...
export function ApproachA() {
  ...
  return (
    <StorePanel
      ...
      description="Computed middleware modificado para percorrer estado aninhado recursivamente. Cada lens tem seu proprio namespace."
    >
      ...
      <div className="service-section cross-lens">
        ...
        <ValueDisplay label="summary" value={store.summaryTeste} />
        <ValueDisplay label="outraCoisa" value={store.outraCoisa} />
        <ValueDisplay
          label="isPositiveAndHasTodos"
          value={store.isPositiveAndHasTodos}
          isComputed
        />
      </div>
    </StorePanel>
